...
| **`workspace/pending_review/setting_entry/`** | **待落户草稿**：设定导入经渲染写出的 `.md`（晋升前）；**非**事实源、**非**本目录；与 `ksfs_root` 分离。说明见仓库根 **`workspace/pending_review/setting_entry/README.md`**、`KSFS开发.md` §2、§7.3。 |
