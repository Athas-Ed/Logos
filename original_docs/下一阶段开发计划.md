...
- **目标**：更新 **`重要子系统开发文档/API-V0.1.md`**（或拆 `API-V0.2.md`），使 **SSE 事件表**与后端/GUI **一致**（例如已实现之 `reasoning_delta` 等）。
...
依据：original_docs/下一阶段开发计划.md §2.1；权威 API 文档在 `original_docs/重要子系统开发文档/API-V0.1.md`（或新建 `API-V0.2.md`）。
